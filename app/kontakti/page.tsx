            ...
            <div className="mx-auto grid max-w-6xl gap-8 px-6 sm:grid-cols-2 lg:px-8">
              <div>
                ...
                <p className="mt-2 text-sm leading-7 text-muted-foreground">
                  Офисът е в София, ж.к. „Хаджи Димитър“, на ул. „Баба Вида“ 1. Работим от понеделник до петък, 09:00–18:00 ч. За среща е добре да се уговори час предварително, за да е свободен колегата, който отговаря за вашия тип дейност.
                </p>
                <a
