        ...
        <div className="flex flex-col md:flex-row items-center justify-between gap-6">
          ...
          <div className="flex items-center gap-3">
            <a
              ...
              aria-label="Facebook"
              className="flex h-8 w-8 items-center justify-center rounded-full text-muted-foreground hover:text-foreground hover:bg-background transition-colors"
            >
            ...
            <span className="text-sm text-muted-foreground">&copy; {new Date().getFullYear()} Total Profit</span>
          </div>
        </div>
      </div>
    </footer>
